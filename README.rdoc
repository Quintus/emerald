...
TODO: Emerald will be available via RubyGems soon...
...
* Provides an easy way to get the anchor links for all your headings.
...
* You can find the GNU GPL in the file COPYING.
* This project incorporates some code and data (mainly images) from
  ...
  LEGAL.rdoc for more information.
